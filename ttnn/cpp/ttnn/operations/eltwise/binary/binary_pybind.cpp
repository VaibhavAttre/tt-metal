...
#include "ttnn/operations/eltwise/binary/tensor_add.hpp"
...
void bind_primitive_add_operation(
    py::module& module, const decltype(ttnn::prim::tensor_add)& operation, const std::string& description) {
    auto doc = std::string{
        R"doc(
    ...
    bind_registered_operation(
        ...
        ttnn::pybind_overload_t{
            [](const decltype(ttnn::prim::tensor_add)& self,
               const ttnn::Tensor& input_tensor_a,
               const ttnn::Tensor& input_tensor_b) -> ttnn::Tensor { return self(input_tensor_a, input_tensor_b); },
            py::arg("input_tensor_a"),
            py::arg("input_tensor_b")});
}

void bind_add_operation(
    py::module& module, const decltype(ttnn::tensor_add)& operation, const std::string& description) {
    auto doc = std::string{
        R"doc(
    ...
    bind_registered_operation(
        ...
        doc,
        ttnn::pybind_overload_t{
            [](const decltype(ttnn::tensor_add)& self,
               const ttnn::Tensor& input_tensor_a,
               const ttnn::Tensor& input_tensor_b) -> ttnn::Tensor { return self(input_tensor_a, input_tensor_b); },
            py::arg("input_tensor_a"),
            py::arg("input_tensor_b")});
