...
void py_module(py::module& module) {
    ...
    // ttnn::operations::eltwise::bind_add_operation(m_binary);
...
PYBIND11_MODULE(_ttnn, module) {
    ...
    */
    ...
    auto m_eltwise = module.def_submodule("eltwise", "elementwise operations");
    // ttnn::operations::eltwise::py_module(m_eltwise);
